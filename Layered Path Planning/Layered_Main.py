...
class Params:
    def __init__(self):
        ...
        self.num_robots = 3
        self.moving_obstacles = 1 # move small cubic obstacles or not
...
obstacles = [
            ...
            np.array([[-1.0, 1.0], [0.5, 1.0], [0.5, 1.5], [-1.0, 1.5]]), # my table
            np.array([[-1.0, 0.0], [0.5, 0.0], [0.5, 0.5], [-1.0, 0.5]]), # my table
            np.array([[-1.0, -1.0], [0.5, -1.0], [0.5, -0.5], [-1.0, -0.5]]), # my table
...
if __name__ == '__main__':
    ...
    draw_map(obstacles)
    plt.plot(xy_start[0],xy_start[1],'bo',color='red', markersize=15, label='start')
    plt.plot(xy_goal[0], xy_goal[1],'bo',color='green', markersize=15, label='goal')
